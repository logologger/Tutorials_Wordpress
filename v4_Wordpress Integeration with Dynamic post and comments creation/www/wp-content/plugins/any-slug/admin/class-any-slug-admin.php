...
class Any_Slug_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Any_Slug_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Any_Slug_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */
        if ( 'settings_page_any-slug' == get_current_screen() -> id ) {
            // CSS stylesheet for Color Picker
            wp_enqueue_style( 'wp-color-picker' );
            wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/any-slug-admin.css', array( 'wp-color-picker' ), $this->version, 'all' );
        }
	...
	public function enqueue_scripts() {
        ...
        if ( 'settings_page_any-slug' == get_current_screen() -> id ) {
            wp_enqueue_media();
            wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/any-slug-admin.js', array( 'jquery', 'wp-color-picker','media-upload'), $this->version, false );
        }
	}
    ...
    public function display_plugin_setup_page() {
        include_once( 'partials/any-slug-admin-display.php' );
    }
    ...
    public function options_update() {
        //Will take care of updating the option value in the DB
        register_setting(
            $this->plugin_name,
            $this->plugin_name,
            array($this, 'validate')
