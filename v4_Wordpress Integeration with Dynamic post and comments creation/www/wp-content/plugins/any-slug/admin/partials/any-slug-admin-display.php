 ...
 *
 * @package    Any_Slug
 * @subpackage Any_Slug/admin/partials
 */
?>
...
<div class="wrap">
    ...
    <form method="post" name="cleanup_options" action="options.php">
        ...
        <fieldset>
            ...
            <div id="upload_logo_preview" class="any-slug-upload-preview <?php if(empty($login_logo_id)) echo 'hidden'?>">
                <img src="<?php echo $login_logo_url; ?>" />
                <button id="any-slug-delete_logo_button" class="any-slug-delete-image">X</button>
            </div>
        </fieldset>

        <!-- login background color-->
        <fieldset class="any-slug-admin-colors">
